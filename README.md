# Understanding Yelp Reviews Through Text Mining
...
- ⭐️ `yelp_text_mining.html`: The rendered HTML version of the final report.
    *Download and open this file to explore the results without running any code.*
